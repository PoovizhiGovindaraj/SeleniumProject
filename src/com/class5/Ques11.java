...
public class Ques11 {
	public static void main (String[]args) throws InterruptedException{
		...
		WebElement target = driver.findElement(By.xpath("//a[text()='Heating & Cooling']"));
		a.moveToElement(target).perform();
		Thread.sleep(1000);
		
		WebElement target1 = driver.findElement(By.xpath("//a[text()='Air Conditioners']"));
		a.moveToElement(target1).perform();
		Thread.sleep(1000);
		
		WebElement target2 = driver.findElement(By.xpath("//a[text()='Air Conditioners']"));
		target2.click();
	}
}
