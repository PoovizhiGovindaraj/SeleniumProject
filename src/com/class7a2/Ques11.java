...
public class Ques11 {
	public static void main (String[]args) throws Exception {
		...
		WebElement kidsAndBaby = driver.findElement(By.xpath("//span[text()='Baby & Kids']"));
		Actions a = new Actions(driver);
		a.moveToElement(kidsAndBaby).perform();
		Thread.sleep(1000);
		...
		File target = new File("C:\\Users\\haris\\eclipse-workspace\\SeleniumProject\\Screenshots\\flipkart.png");
